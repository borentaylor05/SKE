...
app.controller("Maintainer", ['$timeout', 'maintainers', function($timeout, maintainers){
	...
	angular.element(document).ready(function () {
		console.log(getURLParameter('resolved'));
		if(getURLParameter('resolved') == 'true');
			main.getAll(true);
		else
			main.getAll(false);
